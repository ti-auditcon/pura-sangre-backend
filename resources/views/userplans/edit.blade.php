    ...
    <div class="ibox form-control-air">
      ...
      <div class="ibox-body">
        <div class="row">
          ...
          <div class="col-sm-6 form-group mb-4">
       {{--      <div class="form-group">
              <label class="form-control-label">Estado del plan</label>
              <div class="input-group">
                <select class="selectpicker form-control " name="plan_status_id" required id="plan-select">
                  <option value=""> Cambiar estado...</option>
                  <option value="1" @if(old('plan_status_id')) selected @endif>Activo</option>
                  <option value="4" @if(old('plan_status_id')) selected @endif>Completado</option>
                  <option value="5" @if(old('plan_status_id')) selected @endif>Cancelado</option>
                </select>
              </div>
            </div> --}}
