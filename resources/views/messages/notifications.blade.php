        ...
        <div class="input-group-icon input-group-icon-left mr-3">
            ...
            <div class="table-responsive row">
              <div id="datatable_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                <table class="table table-bordered table-hover dataTable no-footer collapsed" id="example" role="grid" aria-describedby="datatable_info" style="width: 1592px;">
                    <thead class="thead-default thead-lg">
                      <tr role="row">
                        <th class="checkboxes-select-all sorting_disabled" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="">
                          <input type="checkbox">
                        </th>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body messages-modal-body">
            <tbody>
              ...
              <button type="button" class="btn btn-primary" type="submit" onClick="this.form.submit();">Enviar Push</button>
            </tbody>
