...
<body
  style="height: 100%;margin: 0;padding: 0;width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background-color: #;">
  ...
  <center>
    <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable"
      style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;height: 100%;margin: 0;padding: 0;width: 100%;background-color: #;">
      <tr>
        <td align="center" valign="top" id="bodyCell"
          style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;height: 100%;margin: 0;padding: 10px;width: 100%;border-top: 1px none;">

          <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer"
            style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;border: 1px none #cfcece;max-width: 600px !important;">
            <tr>
                            ...
                            <tr>
                              <td class="mcnImageContent" valign="top"
                                ...
                                <img align="center" alt=""
                                  src="https://gallery.mailchimp.com/0e8c674a05adecbecad2ee1b4/images/8f696b94-058f-409a-81ca-78610001caea.png"
                                  width="600"
            ...
            <tr>
              <td valign="top" id="templateHeader"
                style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background-color: #FFFFFF;background-image: none;background-repeat: no-repeat;background-position: center;background-size: cover;border-top: 0;border-bottom: 0;padding-top: 9px;padding-bottom: 0;">
              </td>
            </tr>
            <tr>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td valign="top" class="mcnTextContent"
                                ...
                                <h1
                                  style="display: block;margin: 0;padding: 0;color: #202020;font-family: 'Lato', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: left;">
                                  <strong><span style="font-size:30px"><span
                                        style="font-family:lato,helvetica neue,helvetica,arial,sans-serif">Hola
                                        {{$demo->user}},</span></span></strong></h1>
                                ...
                                <p
                                  ...
                                  <br>
                                  <font face="lato, helvetica neue, helvetica, arial, sans-serif"><span
                                      style="font-size:17px">{{$demo->text}}</span></font>
                                </p>


                                @if (isset($demo->image_url) && $demo->image_url)
                                  <div style="text-align: center;">
                                    <img data-file-id="4483155" class="maximo-ancho"
                                        src="{{ $demo->image_url }}"
                                        style="border: 0px initial;max-width: 700px;margin: 0px;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;"
                                    >
                                  </div>
                                @endif
                              </td>
                              ...
                              <td valign="top" class="mcnTextContent"
                                ...
                                <div style="text-align: center;">
                                  <span style="font-size:17px">
                                    <span style="font-family:lato,helvetica neue,helvetica,arial,sans-serif">
                                      Recuerda que nuestra aplicación está para Android y&nbsp;iPhone
                                    </span>
                                  </span><br>
                                </div>
                                ...
                                <div style="text-align: center;">
                                  <a href="https://play.google.com/store/apps/details?id=purasangrecrossfit.app.com&amp;hl=es"
                                    target="_blank"><img data-file-id="448313" height="69"
                                      src="{{ asset('img/icon-store-android.png') }}"
                                      style="border: 0px initial;height: 60px;margin: 0px;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;"
                                      width="200"></a>
                                  <a href="https://apps.apple.com/us/app/pura-sangre-crossfit/id1447657358"
                                    target="_blank"><img data-file-id="448314" height="50"
                                      src="{{ asset('img/icon-store-ios.png') }}"
                                      style="border: 0px initial;height: 60px;margin: 0px;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;"
                                      width="190"></a>
                                </div>
                              </td>
            ...
            <tr>
              <td valign="top" id="templateFooter"
                style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background-color: #bd0a66;background-image: none;background-repeat: no-repeat;background-position: center;background-size: cover;border-top: 0;border-bottom: 1px groove;padding-top: 9px;padding-bottom: 9px;">
                            ...
                            <tr>
                              <td align="center"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="mcnFollowContent"
                                  style="border: 1px none;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                  <tbody>
                                    <tr>
                                      <td align="center" valign="top"
                                                                  ...
                                                                  <tbody>
                                                                    <tr>
                                                                      ...
                                                                      <td align="center" valign="middle" width="24"
                                                                        ...
                                                                        style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                                                        <a href="https://www.facebook.com/purasangrecrossfit/"
                                                                          target="_blank"
                                                                  ...
                                                                  <tbody>
                                                                    <tr>
                                                                      ...
                                                                      <td align="center" valign="middle" width="24"
                                                                        class="mcnFollowIconContent"
                                                                        style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                                                        <a href="https://www.instagram.com/purasangrecf/"
                                                                          target="_blank"
                                                                          style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;"><img
