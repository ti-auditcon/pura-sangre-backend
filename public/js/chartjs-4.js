    ...
    return (
      (l = e.grouped
        ? ((a = n ? this._getStackCount(t) : e.stackCount),
          (s = ('flex' === s.barThickness
            ? computeFlexCategoryTraits
            : computeFitCategoryTraits)(t, e, s, a)),
...
class DoughnutController extends DatasetController {
  ...
  update(t) {
    ...
    var a = i.data,
      ...
      { ratioX: l, ratioY: o, offsetX: h, offsetY: d } = getRatioAndOffset(
        l,
        o,
        n
      ),
  ...
  _getLabelSizes() {
    ...
    if (!e) {
      ...
      i < t.length && (t = sample(t, i)),
        (this._labelSizes = e = this._computeLabelSizes(
          t,
          t.length,
  ...
  drawTitle() {
    ...
    if (a.display) {
      ...
      'bottom' === i || 'center' === i || isObject(i)
        ...
        : (t += r.top);
      var { titleX: r, titleY: l, maxWidth: h, rotation: d } = titleArgs(
        this,
        t,
        i,
        o
  ...
  buildOrUpdateControllers() {
    ...
    for (this._removeUnreferencedMetasets(), a = 0, t = i.length; a < t; a++) {
      ...
      if (
        ...
        var { datasetElementType: s, dataElementType: n } = defaults.datasets[
          n
        ];
        Object.assign(r, {
...
function getBarBounds(t, e) {
  var { x: e, y: i, base: a, width: s, height: n } = t.getProps(
...
class BarElement extends Element {
  ...
  getCenterPoint(t) {
    var { x: t, y: e, base: i, horizontal: a } = this.getProps(
      ['x', 'y', 'base', 'horizontal'],
      t
    );
...
function getBackgroundPoint(t, e, i, a) {
  var { caretSize: t, caretPadding: s, cornerRadius: n } = t,
    { xAlign: i, yAlign: r } = i,
    s = t + s,
    { topLeft: n, topRight: o, bottomLeft: l, bottomRight: h } = toTRBLCorners(
      n
    );
  let d = alignX(e, i);
  var c = alignY(e, r, s);
