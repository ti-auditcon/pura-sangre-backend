                ...
                <div class="card mt-2">
                  ...
                  <div id="collapsableInfo" class="m-0 p-0 collapse" aria-labelledby="headingOne" data-parent="#accordion">
                    <div class="card-body m-0 pl-2 py-0">
                      <div class="row">
                        <div class="col-12">
                          <p class="mt-1"><strong>Activos inicio:</strong> Los datos de retención y rotación se calculan a partir de los datos de alumnos activos.</p>
                          <p class=""><strong>Activos término:</strong> La cantidad de alumnos que han dejado de ser activos durante el período.</p>
                          <p class=""><strong>Bajas:</strong> La cantidad de alumnos que han dejado de ser activos durante el período.</p>
                          <p class=""><strong>% Bajas:</strong> El porcentaje de alumnos que han dejado de ser activos con respecto al total de alumnos activos.</p>
                          <p class=""><strong>Nuevos:</strong> La cantidad de nuevos alumnos que se han inscrito durante el período.</p>
                          <p class=""><strong>% Nuevos:</strong> El porcentaje de nuevos alumnos con respecto al total de alumnos activos.</p>
