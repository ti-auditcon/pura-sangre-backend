                    ...
                    <div class="col-sm-6 form-group mb-2">
                        <div class="form-group" id="start_date">
                            ...
                            <div class="input-group date">
                                ...
                                <input autocomplete="off" class="form-control" name="from" value="{{ old('from') }}" type="text" value="{{ date('d-m-Y') }}" required>
                        	</div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 form-group mb-2">
                        <div class="form-group" id="finish_date">
                            ...
                            <div class="input-group date">
                                ...
                                <input autocomplete="off" class="form-control" name="to" value="{{ old('to') }}" type="text" value="{{ date('d-m-Y') }}" required>
                        	</div>
                        </div>
                    </div>
          		</div>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover table-striped collapsed" id="alert-list-table" style="width: 1592px;">
                        <thead class="thead-default thead-lg">
                            <tr role="row">
                                <th class="sorting" width="50%">Mensaje</th>
