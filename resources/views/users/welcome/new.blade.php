    ...
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #2EB6EC;">
                    <tbody>
                        <tr>
										...
										<tbody>
											<tr>
												<td valign="top" class="mcnTextContent" style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">
														...
														<div style="text-align: center;"><span style="font-size:17px"><span style="font-family:lato,helvetica neue,helvetica,arial,sans-serif">Además, te invitamos a descargar nuestra aplicación en Google Play Store y AppStore. Acá abajo te dejamos los enlaces a la App:</span></span><br>
													&nbsp;</div>
